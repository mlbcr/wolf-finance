...
export default function AlunosPage() {
    ...
    async function handleImportarArquivo(event) {
        ...
        try {
            ...
            if (quantidadeErros === 0) {
                ...
                alert(
                    `${quantidade} alunos cadastrados com sucesso!`
                )
                ...
                alert(
                    `${quantidade} alunos cadastrados com sucesso.\n\n` +
                    `${quantidadeErros} alunos não puderam ser cadastrados.`
                )
        ...
        <main className="alunos-page">
            ...
            <div className="alunos-header">
                ...
                <div className="alunos-header-actions">
                    ...
                    <label
                        className={`btn-importar-alunos ${importando
                            ? 'importando'
                            : ''
                            }`}
                    >
